        ...
        Column(
            ...
            Column {
                ...
                Card(
                    ...
                    Column(modifier = Modifier.padding(16.dp)) {
                        Text("Name: ${exercise.exerciseName}", style = AppTypography.bodyLarge)
                        Text("Type: ${exercise.type}", style = AppTypography.bodyLarge)
                        Text("Muscle: ${exercise.muscle}", style = AppTypography.bodyLarge)
                        Text("Difficulty: ${exercise.difficulty}", style = AppTypography.bodyLarge)
                        Text("Week: ${exercise.week}", style = AppTypography.bodyLarge)
                        Text("Sets: ${exercise.sets}", style = AppTypography.bodyLarge)
                        Text("Reps: ${exercise.reps}", style = AppTypography.bodyLarge)
                    }
                }
            }
            ...
            Column {
                ...
                Button(
                    ...
                    Text("Delete Exercise", color = MaterialTheme.colorScheme.onError)
                }
